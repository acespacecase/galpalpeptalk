...
function renderHTML(data) {
  ...
  // find random lyric within specific song object; insert it into the dom
  var pickLyric = Math.floor(Math.random() * data[pickSong].quotes.length);
  quoteContainer.innerHTML = data[pickSong].quotes[pickLyric];
